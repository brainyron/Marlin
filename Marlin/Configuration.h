...
#define CUSTOM_MACHINE_NAME "Anycubic 1.1.8"
...
#define PID_K1 0.95      // Smoothing factor within the PID
  ...
  // Anycubic Delta Linear Plus with E3Dv6 Hotend (brainyron)
  #define DEFAULT_Kp 16.11
  #define DEFAULT_Ki 1.31
  #define DEFAULT_Kd 49.49
...
#define DELTA
  ...
  #define DELTA_HEIGHT 289.65 // get this value from auto calibrate
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -15.27   // Z offset: -below +above  [the nozzle]
